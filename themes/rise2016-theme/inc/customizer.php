<?php
/**
 * Rise 2016 Customizer functionality
 *
 * @package WordPress
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in Rise 2016.
	 *
	 * @since Rise 2016 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in Rise 2016.
	 *
	 * @since Rise 2016 1.0
	 *
	 * @param array $args {
...
/**
 * Registers color schemes for Rise 2016.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Rise 2016.
	 *
...
/**
 * Retrieves the current Rise 2016 color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for Rise 2016.
 *
...
/**
 * Handles sanitization for Rise 2016 color schemes.
 *
